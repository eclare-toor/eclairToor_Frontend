...
import { getNotifications, getTrips, adminCreateBooking, getDashboardStats, getUsers, adminRegister } from '../../api';
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Dialog open={isAdminModalOpen} onOpenChange={setIsAdminModalOpen}>
            ...
            <DialogContent className="sm:max-w-[550px] rounded-[2.5rem] p-8 max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle className="text-3xl font-black text-slate-900 mb-6">Nouvel <span className="text-primary italic">Admin</span></DialogTitle>
              </DialogHeader>
              <form onSubmit={handleCreateAdmin} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label className="text-xs font-black uppercase text-slate-400">Nom</Label>
                    <Input
                      value={adminForm.nom}
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs font-black uppercase text-slate-400">Prénom</Label>
                    <Input
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-black uppercase text-slate-400">Mot de passe</Label>
                  <Input
                    type="password"
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-black uppercase text-slate-400">Téléphone</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-black uppercase text-slate-400">Lien Facebook</Label>
                  <Input
                    value={adminForm.linkFacebook}
                    onChange={e => setAdminForm({ ...adminForm, linkFacebook: e.target.value })}
                    className="h-12 rounded-xl bg-slate-50 border-slate-100 font-bold"
                  />
                </div>

                <DialogFooter className="pt-4">
                  <Button type="submit" className="w-full h-14 rounded-2xl font-black uppercase tracking-widest shadow-lg shadow-primary/20">
          ...
          <Dialog open={isBookingModalOpen} onOpenChange={setIsBookingModalOpen}>
            ...
            <DialogContent className="sm:max-w-[550px] rounded-[2.5rem] p-8 max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleCreateBooking} className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-xs font-black uppercase tracking-wider text-slate-400">Sélectionner l'Utilisateur</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-black uppercase tracking-wider text-slate-400">Sélectionner le Voyage</Label>
                  <div className="relative">
                ...
                <div className="flex justify-between items-center p-4 bg-slate-900 rounded-2xl shadow-xl shadow-slate-200 overflow-hidden relative">
                  <div className="relative z-10">
                    <p className="text-[10px] font-black uppercase tracking-wider text-slate-400 mb-1">Prix Total Estimé</p>
                ...
                <DialogFooter className="mt-8">
                  <Button type="submit" className="w-full h-16 rounded-[1.5rem] font-black uppercase tracking-wider shadow-xl shadow-primary/20 hover:shadow-primary/40 transition-all flex items-center justify-center gap-3">
