...
import { Building, MapPin, Calendar, Users, Star, ArrowRight } from 'lucide-react';
            ...
            <div className="container mx-auto max-w-3xl">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-600 max-w-2xl mx-auto">
                        Trouvez l'hébergement parfait pour votre séjour. Dites-nous où et quand, nous nous occupons du reste.
                    </p>
                </div>
