...
const TripCard: React.FC<TripCardProps> = ({ trip }) => {
    ...
    return (
        <motion.div
            ...
            className="group relative flex h-full flex-col overflow-hidden rounded-[2rem] bg-white border border-slate-100 shadow-xl shadow-slate-200/40 transition-all hover:shadow-2xl hover:shadow-primary/10"
        >
